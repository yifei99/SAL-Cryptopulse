...
def _add_hanging_indent(text, indent_size=4):
    ...
    # wrap the text to fit within the defined width
...
parser.add_argument(
    "--ob-len", type=int, default=96, help="Length of observation sequence."
)
parser.add_argument(
    "--pred-len", type=int, default=96, help="Length of prediction sequence."
)
parser.add_argument(
    "--data",
    type=str,
...
parser.add_argument(
    "--enc-in-channels", type=int, default=-1, help="Channels of input for encoder."
)
parser.add_argument(
    "--dec-in-channels", type=int, default=-1, help="Channels of input for decoder."
)
parser.add_argument(
    "--dec-out-channels", type=int, default=-1, help="Channels of the output."
)
# Transformers - model settings
...
parser.add_argument(
    ...
    help=(
        ...
        "epoch_hard_threshold_x: 0.1 * lr once ecpoch > x."
...
parser.add_argument(
    ...
    default="Test",
    help=(
        "Name of this experiment. Will also be used as the " "folder name in results."
    ),
)
